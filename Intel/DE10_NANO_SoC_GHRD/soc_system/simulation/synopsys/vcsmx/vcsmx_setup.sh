...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/soc_system_gpio_1_d34_d32_d30_d28.v"                     -work gpio_1_d34_d32_d30_d28          
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/soc_system_adc_measured_32.v"                            -work adc_measured_32                 
