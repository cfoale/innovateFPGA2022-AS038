...
# ACDS 18.1 625 win32 2021.11.29.12:36:08
# ----------------------------------------
...
ensure_lib                                  ./libraries/gpio_1_d34_d32_d30_d28          
vmap       gpio_1_d34_d32_d30_d28           ./libraries/gpio_1_d34_d32_d30_d28          
...
ensure_lib                                  ./libraries/adc_measured_32                 
vmap       adc_measured_32                  ./libraries/adc_measured_32                 
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_gpio_1_d34_d32_d30_d28.v"                                                  -work gpio_1_d34_d32_d30_d28          
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_adc_measured_32.v"                                                         -work adc_measured_32                 
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L fpga_interfaces -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L rst_controller -L irq_mapper_002 -L irq_mapper_001 -L irq_mapper -L mm_interconnect_3 -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L sysid_qsys -L mm_bridge_0 -L led_pio -L jtag_uart -L hps_0 -L gpio_1_d34_d32_d30_d28 -L f2sdram_only_master -L dipsw_pio -L button_pio -L adc_measured_32 -L ILC -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
