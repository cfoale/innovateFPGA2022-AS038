...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_gpio_1_d34_d32_d30_d28.v"                     -work gpio_1_d34_d32_d30_d28           -cdslib ./cds_libs/gpio_1_d34_d32_d30_d28.cds.lib          
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_adc_measured_32.v"                            -work adc_measured_32                  -cdslib ./cds_libs/adc_measured_32.cds.lib                 
