	soc_system u0 (
		...
		.cc_out_external_connection_export                 (<connected-to-cc_out_external_connection_export>),                 //                 cc_out_external_connection.export
		...
		.fifo_usedw32_external_connection_export           (<connected-to-fifo_usedw32_external_connection_export>),           //           fifo_usedw32_external_connection.export
		.fpga_dsp_byte_external_connection_export          (<connected-to-fpga_dsp_byte_external_connection_export>),          //          fpga_dsp_byte_external_connection.export
		.gpio_1_d34_d32_d30_d28_external_connection_export (<connected-to-gpio_1_d34_d32_d30_d28_external_connection_export>), // gpio_1_d34_d32_d30_d28_external_connection.export
		...
		.hps_dsp_byte_external_connection_export           (<connected-to-hps_dsp_byte_external_connection_export>),           //           hps_dsp_byte_external_connection.export
		.hps_dsp_threshold_external_connection_export      (<connected-to-hps_dsp_threshold_external_connection_export>),      //      hps_dsp_threshold_external_connection.export
		.hps_fifo_wrfull_external_connection_export        (<connected-to-hps_fifo_wrfull_external_connection_export>),        //        hps_fifo_wrfull_external_connection.export
		.hps_read_clk_external_connection_export           (<connected-to-hps_read_clk_external_connection_export>),           //           hps_read_clk_external_connection.export
		.hps_read_rq_external_connection_export            (<connected-to-hps_read_rq_external_connection_export>),            //            hps_read_rq_external_connection.export
		.hps_read_status_external_connection_export        (<connected-to-hps_read_status_external_connection_export>),        //        hps_read_status_external_connection.export
		.hps_word16_external_connection_export             (<connected-to-hps_word16_external_connection_export>),             //             hps_word16_external_connection.export
